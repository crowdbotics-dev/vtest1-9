...
export const api_v1_user_list = createAsyncThunk(
...
export const api_v1_user_create = createAsyncThunk(
...
export const api_v1_user_retrieve = createAsyncThunk(
  "users/api_v1_user_retrieve",
  async payload => {
    const response = await apiService.api_v1_user_retrieve(payload)
    return response.data
  }
)
export const api_v1_user_update = createAsyncThunk(
...
export const api_v1_user_partial_update = createAsyncThunk(
...
export const api_v1_user_destroy = createAsyncThunk(
  "users/api_v1_user_destroy",
  async payload => {
