...
export const api_v1_main_menu_list = createAsyncThunk(
  "main_menus/api_v1_main_menu_list",
  async payload => {
    const response = await apiService.api_v1_main_menu_list(payload)
    return response.data
  }
)
export const api_v1_main_menu_create = createAsyncThunk(
  "main_menus/api_v1_main_menu_create",
  async payload => {
    const response = await apiService.api_v1_main_menu_create(payload)
    return response.data
  }
)
export const api_v1_main_menu_retrieve = createAsyncThunk(
  "main_menus/api_v1_main_menu_retrieve",
  async payload => {
    const response = await apiService.api_v1_main_menu_retrieve(payload)
    return response.data
  }
)
export const api_v1_main_menu_update = createAsyncThunk(
  "main_menus/api_v1_main_menu_update",
  async payload => {
    const response = await apiService.api_v1_main_menu_update(payload)
    return response.data
  }
)
export const api_v1_main_menu_partial_update = createAsyncThunk(
  "main_menus/api_v1_main_menu_partial_update",
  async payload => {
    const response = await apiService.api_v1_main_menu_partial_update(payload)
    return response.data
  }
)
export const api_v1_main_menu_destroy = createAsyncThunk(
  "main_menus/api_v1_main_menu_destroy",
  async payload => {
