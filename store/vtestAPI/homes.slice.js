...
export const api_v1_home_list = createAsyncThunk("homes/api_v1_home_list", async payload => {
  const response = await apiService.api_v1_home_list(payload);
  return response.data;
});
export const api_v1_home_create = createAsyncThunk("homes/api_v1_home_create", async payload => {
  const response = await apiService.api_v1_home_create(payload);
  return response.data;
});
export const api_v1_home_retrieve = createAsyncThunk("homes/api_v1_home_retrieve", async payload => {
  const response = await apiService.api_v1_home_retrieve(payload);
  return response.data;
});
export const api_v1_home_update = createAsyncThunk("homes/api_v1_home_update", async payload => {
  const response = await apiService.api_v1_home_update(payload);
  return response.data;
});
export const api_v1_home_partial_update = createAsyncThunk("homes/api_v1_home_partial_update", async payload => {
  const response = await apiService.api_v1_home_partial_update(payload);
  return response.data;
});
export const api_v1_home_destroy = createAsyncThunk("homes/api_v1_home_destroy", async payload => {
